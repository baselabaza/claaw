...
return false  end
if tonumber(user) == tonumber(TH3NEk) then  
...
if redis:get(TH3NEk.."Add:Pin"..msg.chat_id_) then
pin_msg = 'true'
pin = 'ꪜ'
else
pin_msg = 'false'
...
if redis:get(TH3NEk.."Add:Kick"..msg.chat_id_) then
Add_Kick = 'true'
kick = 'ꪜ'
else
Add_Kick = 'false'
...
if redis:get(TH3NEk.."Add:Info"..msg.chat_id_) then
Add_Info = 'true'
info = 'ꪜ'
else
Add_Info = 'false'
...
if redis:get(TH3NEk.."Add:Set:Admin"..msg.chat_id_) then
Add_SetAdmin = 'true'
adde = 'ꪜ'
else
Add_SetAdmin = 'false'
...
if redis:get(TH3NEk.."Add:Del"..msg.chat_id_) then
Add_Del = 'true'
del = 'ꪜ'
else
Add_Del = 'false'
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(TH3NEk.."Add:Pin"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(TH3NEk.."Add:Pin"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(TH3NEk.."Add:Del"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(TH3NEk.."Add:Del"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(TH3NEk.."Add:Set:Admin"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(TH3NEk.."Add:Set:Admin"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(TH3NEk.."Add:Info"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(TH3NEk.."Add:Info"..msg.chat_id_)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(TH3NEk.."Add:Kick"..msg.chat_id_,true)   
...
storm_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(TH3NEk.."Add:Kick"..msg.chat_id_)   

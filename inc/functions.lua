...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(TH3NEk..":NameBot:")
...
var = 'مطور اساسي ' 
elseif redis:sismember(TH3NEk..':SUDO_BOT:',UserID) then
var = 'مطور البوت ' 
elseif redis:sismember(TH3NEk..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(TH3NEk..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء ' 
elseif redis:sismember(TH3NEk..'owners:'..ChatID,UserID) then
var = 'مدير البوت ' 
elseif redis:sismember(TH3NEk..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت ' 
elseif redis:sismember(TH3NEk..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ' 
else
var = 'فقط عضو ' 
end
...
if msg.edited then
redis:incr(TH3NEk..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(TH3NEk..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(TH3NEk..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(TH3NEk..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(TH3NEk..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(TH3NEk..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(TH3NEk..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(TH3NEk..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(TH3NEk..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(TH3NEk..':SUDO_BOT:')
message = '-  قائمه الـمـطـوريـن : \n\n`- مطور اساسي`**\n'..SUDO_USER..' ➦ ❪' ..SUDO_ID.. '❫\n*———————— *\n'
if #list==0 then  message = message.."* - لا يوجد مطورين حاليا \n®️*"
else
for k,v in pairs(list) do
local info = redis:hgetall(TH3NEk..'username:'..v)
local count = redis:scard(TH3NEk..'mtwr_count'..v)
...
local monsha = redis:smembers(TH3NEk..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————  \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(TH3NEk..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(TH3NEk..'admins:'..msg.chat_id_)
...
local list = redis:smembers(TH3NEk..'whitelist:'..msg.chat_id_)
...
if redis:sismember(TH3NEk..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(TH3NEk..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(TH3NEk..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(TH3NEk..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(TH3NEk..'gban_users')
...
local list = redis:smembers(TH3NEk..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(TH3NEk..':Filter_Word:'..msg.chat_id_,word) then 
return  "- **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(TH3NEk..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(TH3NEk..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(TH3NEk..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(TH3NEk..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(TH3NEk..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(TH3NEk..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(TH3NEk..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(TH3NEk..'group:ids')
message = '- **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(TH3NEk..'group:name'..v)
if info then 
...
redis:del(
TH3NEk..'group:add'..id_group,
TH3NEk..'lock_link'..id_group, 
TH3NEk..'lock_id'..id_group,
TH3NEk..'lock_spam'..id_group, 
TH3NEk..'lock_webpage'..id_group,
TH3NEk..'lock_markdown'..id_group,
TH3NEk..'lock_flood'..id_group,
TH3NEk..'lock_bots'..id_group,
TH3NEk..'mute_forward'..id_group,
TH3NEk..'mute_contact'..id_group,
TH3NEk..'mute_location'..id_group,
TH3NEk..'mute_document'..id_group,
TH3NEk..'mute_keyboard'..id_group,
TH3NEk..'mute_game'..id_group,
TH3NEk..'mute_inline'..id_group,
TH3NEk..'lock_username'..id_group,
TH3NEk..'num_msg_TH3NEk'..id_group,
TH3NEk..'replay'..id_group
)
redis:srem(TH3NEk..'group:ids',id_group)
end
...
redis:hset(TH3NEk..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(TH3NEk..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(TH3NEk..'group:add'..msg.chat_id_) then  return '•**المجموعه بالتأكيد تم تفعيلها' end
...
redis:setex(TH3NEk..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(TH3NEk..':addnumberusers') or 0)
...
local lock_service = redis:get(TH3NEk..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(TH3NEk..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(TH3NEk..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
TH3NEk..'group:add'..msg.chat_id_,true,
TH3NEk..'lock_link'..msg.chat_id_,true, 
TH3NEk..'lock_id'..msg.chat_id_,true,
TH3NEk..'lock_spam'..msg.chat_id_,true,
TH3NEk..'lock_webpage'..msg.chat_id_,true,
TH3NEk..'lock_markdown'..msg.chat_id_,true,
TH3NEk..'lock_flood'..msg.chat_id_,true,
TH3NEk..'lock_bots'..msg.chat_id_,true,
TH3NEk..'mute_forward'..msg.chat_id_,true,
TH3NEk..'mute_contact'..msg.chat_id_,true,
TH3NEk..'mute_location'..msg.chat_id_,true,
TH3NEk..'mute_document'..msg.chat_id_,true,
TH3NEk..'mute_keyboard'..msg.chat_id_,true,
TH3NEk..'mute_game'..msg.chat_id_,true,
TH3NEk..'mute_inline'..msg.chat_id_,true,
TH3NEk..'lock_username'..msg.chat_id_,true,
TH3NEk..'num_msg_TH3NEk'..msg.chat_id_,5, 
TH3NEk..'replay'..msg.chat_id_,true
)

redis:sadd(TH3NEk..'group:ids',msg.chat_id_) 
redis:sadd(TH3NEk..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(TH3NEk..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(TH3NEk..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(TH3NEk..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
if redis:sismember(TH3NEk..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID,'username',Resolv)
redis:sadd(TH3NEk..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(TH3NEk..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(TH3NEk..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID,'username',Resolv)
redis:sadd(TH3NEk..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(TH3NEk..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(TH3NEk..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(TH3NEk..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..'whitelist:'..ChatID,UserID)
...
if redis:sismember(TH3NEk..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..'owners:'..ChatID,UserID)
...
if redis:sismember(TH3NEk..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(TH3NEk..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(TH3NEk..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(TH3NEk..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(TH3NEk..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..'banned:'..ChatID,UserID)
...
if redis:sismember(TH3NEk..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(TH3NEk..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(TH3NEk..'username:'..UserID, 'username',Resolv)
redis:sadd(TH3NEk..'gban_users',UserID)
...
redis:srem(TH3NEk..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(TH3NEk..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(TH3NEk..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(TH3NEk..':SUDO_BOT:',UserID)
...
redis:hset(TH3NEk..'username:'..UserID, 'username', UserName)
redis:sadd(TH3NEk..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو ➦ ❪ '..UserName..' ❫\n- **الايدي ➦ ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(TH3NEk..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'- **العضو ➦ ❪ '..UserName..' ❫\n- **الايدي ➦ ❪ `'..UserID..'` ❫\n- **تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(TH3NEk..'username:'..UserID, 'username', Resolv)
redis:sadd(TH3NEk..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(TH3NEk..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ➦ ❪ '..USERNAME..' ❫\n- الايدي ➦ ❪ '..UserID..' ❫\n- تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(TH3NEk..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(TH3NEk..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'-**العضو ➦ '..USERNAME..' \n-** الايدي ➦ (`'..UserID..'`)\n-**انه بالتأكيد ليس مطور \n✓') end
redis:srem(TH3NEk..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'-العضو ➦ ❪ '..USERNAME..' ❫\n-الايدي ➦ ❪ '..UserID..' ❫\n-تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(TH3NEk..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(TH3NEk..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(TH3NEk..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(TH3NEk..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*-* اعدادات المجموعه : \n"
.."\n1-╿التعديل «➦ "..(redis:get(TH3NEk..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط «➦ "..(redis:get(TH3NEk..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك «➦ "..(redis:get(TH3NEk..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات «➦ "..(redis:get(TH3NEk..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار «➦ "..(redis:get(TH3NEk..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش «➦ "..(redis:get(TH3NEk..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب «➦ "..(redis:get(TH3NEk..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان «➦ "..(redis:get(TH3NEk..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات «➦ "..(redis:get(TH3NEk..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات «➦ "..(redis:get(TH3NEk..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار «➦ "..(redis:get(TH3NEk..'num_msg_TH3NEk'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه «➦ "..(redis:get(TH3NEk..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه «➦ "..(redis:get(TH3NEk..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين «➦ "..(redis:get(TH3NEk..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب «➦"..(redis:get(TH3NEk..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور «➦ "..(redis:get(TH3NEk..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو «➦ "..(redis:get(TH3NEk..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات «➦ "..(redis:get(TH3NEk..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت «➦ "..(redis:get(TH3NEk..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات «➦ "..(redis:get(TH3NEk..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات «➦ "..(redis:get(TH3NEk..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه «➦ "..(redis:get(TH3NEk..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع «➦ "..(redis:get(TH3NEk..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات «➦ "..(redis:get(TH3NEk..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات «➦ "..(redis:get(TH3NEk..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد «➦ "..(redis:get(TH3NEk..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب «➦ "..welcomex
.."\n*2-│*الردود «➦ "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك «➦ "..(redis:get(TH3NEk..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات «➦ "..(redis:get(TH3NEk..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل «➦ "..(redis:get(TH3NEk..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط «➦ "..(redis:get(TH3NEk..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار «➦ "..(redis:get(TH3NEk..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش «➦ "..(redis:get(TH3NEk..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب «➦ "..(redis:get(TH3NEk..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان «➦ "..(redis:get(TH3NEk..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد «➦ "..(redis:get(TH3NEk..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات «➦ "..(redis:get(TH3NEk..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار «➦ "..(redis:get(TH3NEk..'num_msg_TH3NEk'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه «➦ "..(redis:get(TH3NEk..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور «➦ "..(redis:get(TH3NEk..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط «➦ "..(redis:get(TH3NEk..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه «➦ "..(redis:get(TH3NEk..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو «➦ "..(redis:get(TH3NEk..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
